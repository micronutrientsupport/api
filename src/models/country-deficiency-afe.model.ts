...
export class CountryDeficiencyAfe extends Entity {
  @property({
    type: 'string',
    postgresql: {columnName: 'aggregation_area_id', dataType: 'text', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  aggregationAreaId?: string;

  @property({
    type: 'string',
    postgresql: {columnName: 'aggregation_area_name', dataType: 'text', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  aggregationAreaName?: string;

  @property({
    type: 'string',
    postgresql: {columnName: 'aggregation_area_type', dataType: 'text', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  ...
  @property({
    type: 'number',
    postgresql: {columnName: 'dietary_supply', dataType: 'numeric', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  ...
  @property({
    type: 'number',
    postgresql: {columnName: 'deficient_value', dataType: 'numeric', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  deficientValue?: number;

  @property({
    type: 'string',
    postgresql: {columnName: 'deficient_percentage', dataType: 'text', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
...
export type CountryDeficiencyAfeWithRelations = CountryDeficiencyAfe & CountryDeficiencyAfeRelations;
