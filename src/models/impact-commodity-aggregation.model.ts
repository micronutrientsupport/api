...
@model({
  settings: {
    ...
    postgresql: {
      ...
      table: 'impact_commodity_aggregation',
    },
  },
})
export class ImpactCommodityAggregation extends Entity {
  ...
  @property({
    type: 'string',
    description:
      'Name of the commodity contributing to the micronutrient supply',
    postgresql: {
...
export type ImpactCommodityAggregationWithRelations = ImpactCommodityAggregation &
