...
@model({
  settings: {
    ...
    postgresql: {
      ...
      table: 'household_consumption_fctlist_matches',
    },
  },
})
export class HouseholdConsumptionFctlistMatches extends Entity {
  @property({
    type: 'number',
    scale: 0,
    id: true,
  ...
  constructor(data?: Partial<HouseholdConsumptionFctlistMatches>) {
    super(data);
  }
}

export interface HouseholdConsumptionFctlistMatchesRelations {
  // describe navigational properties here
}

export type HouseholdConsumptionFctlistMatchesWithRelations = HouseholdConsumptionFctlistMatches &
